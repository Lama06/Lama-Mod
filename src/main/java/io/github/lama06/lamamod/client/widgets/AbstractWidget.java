...
import static io.github.lama06.lamamod.client.util.ClientUtil.sendMsgToPlayer;
...
public abstract class AbstractWidget<T extends WidgetOptions> extends DrawableHelper implements HudRenderCallback, MessageSentCallback {
     ...
     */
    protected abstract T getWidgetOptions(ClientOptions options);

    protected T getWidgetOptions() {
        return getWidgetOptions(ClientOptions.getOptions());
    }
